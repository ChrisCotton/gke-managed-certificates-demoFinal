...
# Check that DNS is valid
#   echo "ERROR - Domain name ${mydomain} invalid" and exit unless  curl command to ${domain} returns 200
#
#   echo "Step 1 of validation passed. DNS is valid."
#
...
echo "Step 2 of the validation passed. App is deployed."
...
echo "Step 3 of the validation passed. App handles requests."

# Verify Valid Certificate
#
#    echo "ERROR - Valid Certificate Not Found. " and exit  unless curl command returns Valid certificate
#
#    echo "Step 4 of the validation passed. App has valid Certificate"

# Verify Certificate Will Autorenew?
#
#    echo "ERROR - Autorenew Setting Not Found. " and exit unless config file indicates certificate will autorenew
#
#    echo "Step 5 of the validation passed. Autorenew is on"
#
