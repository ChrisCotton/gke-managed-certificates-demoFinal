...
echo '################## GENERATE_TFVARS SCRIPT ##################'
# Stop immediately if something goes wrong
set -euo pipefail

# TODO - These both may need to be changed to be set elsewhere, but we need this set so it is consistent for the TF and SH scripts.
CLUSTER_NAME="gke-managed-certificates-demo12"
DOMAIN="jld.com"
